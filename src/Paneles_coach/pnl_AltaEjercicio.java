 ...
 * @author juana
 */
public class pnl_AltaEjercicio extends javax.swing.JPanel {
    ...
    public pnl_AltaEjercicio(Menu_coach_interfaz interfaz_menu_padre, BufferedReader inSocket, PrintWriter outSocket ) {
        initComponents();
    ...
    private void initComponents() {
        ...
        descripcion_tf.setCaretColor(new java.awt.Color(255, 255, 255));
